...
window.TuchaChat = (function () {
  ...
  var BAZA = [
    ...
    { k: ['адрес', 'где вы', 'где наход', 'добрать', 'проезд', 'подолино', 'химки', 'на карте'], a: 'Московская обл., г. о. Химки, д. Подолино, стр. 2с2: 10 минут от МКАД и Шереметьева. <a href="~/kontakty/">Схема проезда</a>' },
