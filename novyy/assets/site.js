...
window.Tucha = (function () {
  ...
  var KLUB = [
    ...
    { imya: 'Туча Про', mes: 9, kogda: '9 месяцев подряд', zad: ['Прогноз отгрузок на месяц, точность ±20 %', 'Товара без движения не больше 10 %'],
      daet: ['Скидка 5 % на хранение', '6 приёмок и 12 возвратов в месяц', 'Приоритет отгрузки всегда', 'Доставка попуткой'], skidka: 5 },
    { imya: 'Туча Макс', mes: 12, kogda: '12 месяцев подряд', zad: ['Половина мест в резервации «Займи место под Тучей»', 'От 10 карточек на Витрине'],
  ...
  return {
    ...
    kakSvyazhetsya: kakSvyazhetsya, korzObnovit: korzObnovit, KLUB: KLUB, PAKETY: PAKETY, klubUroven: klubUroven, zadanieMesyaca: zadanieMesyaca
  };
})();
