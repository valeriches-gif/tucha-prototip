...
window.TuchaChat = (function () {
  ...
  var BAZA = [
    ...
    { k: ['сменить персонаж', 'другого персонаж', 'поменять персонаж', 'не сошлись', 'характер', 'заменить менеджер', 'сменить менеджер'], a: 'Да, персонажа можно сменить: если не сошлись характерами, соберите другого в кабинете, в разделе «Персонаж». Постройка и история останутся.' },
