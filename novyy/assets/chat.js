...
window.TuchaChat = (function () {
  ...
  var BAZA = [
    ...
    { k: ['уровн', 'тучка', 'туча макс', 'мировая туча', 'привилег', 'ступен'], a: 'В «Мире Тучи» семь уровней: от «Под тучей» до «Мировой Тучи». Растут за месяцы с выполненными условиями: оплата вовремя, заявки заранее, прогноз отгрузок. Каждый даёт привилегии, с «Тучи Про» и скидку на хранение.' },
