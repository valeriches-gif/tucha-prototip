...
window.TuchaChat = (function () {
  ...
  var BAZA = [
    ...
    { k: ['лавк', 'витрин', 'купить', 'покупател'], a: 'Лавка: маркетплейс склада, откроется позже. <a href="~/lavka/#list">Оставьте почту</a>, напишем первыми.' },
    { k: ['физлиц', 'физ лиц', 'частн', 'личные вещ'], a: 'Хранение: для компаний и ИП. Физлица смогут покупать в Лавке, когда она откроется.' },
